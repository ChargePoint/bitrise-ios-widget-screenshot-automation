...
struct SampleWidgetSmallView: View {
...
struct SampleWidgetSmallView_Previews: PreviewProvider {
    static var previews: some View {
        SampleWidgetSmallView(stationStatusColors:[Color.green, Color.gray, Color.blue], locationName: "San Jose", poiList: mockPOIs)
